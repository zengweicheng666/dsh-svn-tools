    ...
    function SidesView(props) {
      ...
      var navRow = changeBlocks.length > 0
        ? h("div", { className: "dsh-svn-navrow" },
            h("button", { className: "dsh-svn-navbtn", title: "Previous difference", onClick: function () { nav(-1); } }, "◀ 上一处"),
            h("button", { className: "dsh-svn-navbtn", title: "Next difference", onClick: function () { nav(1); } }, "下一处 ▶"),
        ...
        return h("div", { className: "dsh-svn-row", key: e.path, onClick: function () { props.onDiff(e.path); } },
          ...
          h("span", { className: "dsh-svn-rowops", onClick: function (ev) { ev.stopPropagation(); } },
            ...
            !isNew && !isConflict
              ...
              : null,
            !isNew && !isConflict
              ? h("button", { className: "dsh-svn-mini", onClick: function () { props.onRevert([e.path]); } }, "Revert")
              : null
          )
        );
      });
      ...
      if (checkoutMode) {
        ...
        body = h("div", { className: "dsh-svn-commitpage", ref: cmpWrapRef },
          h("div", { className: "dsh-svn-commitpage-list", style: { height: cmpPct + "%" } },
            h(ChangesView, { entries: entries || [], summary: summary, sel: sel,
