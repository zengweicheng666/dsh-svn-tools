...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      ".dsh-svn-histlist{flex:1;min-height:0;overflow:auto}",
      ".dsh-svn-logrow.on{background:rgba(88,166,255,.12)}",
      ".dsh-svn-histdetail{flex:0 0 auto;max-height:45%;min-height:0;overflow:auto;border-top:1px solid rgba(148,163,184,.15);background:rgba(148,163,184,.04)}",
      ".dsh-svn-histdhead{display:flex;gap:8px;align-items:baseline;padding:6px 12px 2px;font-size:11px}",
    ...
    function HistoryView(props) {
      ...
      return h("div", { className: "dsh-svn-hist" },
        h("div", { className: "dsh-svn-histlist" }, rows),
        detail
      );
    }
