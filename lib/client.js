  ...
  factory: (require) => {
    ...
    function HistoryView(props) {
      ...
      var rows = entries.map(function (e) {
        ...
        return h("div", { className: "dsh-svn-logrow" + (on ? " on" : "") + (isCur ? " cur" : ""), key: e.revision, onClick: function () { props.onSelectRev(e.revision); } },
          h("div", { className: "dsh-svn-loghead" },
            h("span", { className: "dsh-svn-logrev" }, "r" + e.revision),
            isCur ? h("span", { className: "dsh-svn-curtag" }, "本地当前") : null,
    ...
    function SvnPanel(props) {
      ...
      if (checkoutMode) {
        ...
        body = h(HistoryView, { entries: logs || [], openRev: openRev,
          ...
          localRev: repo ? repo.revision : undefined,
