...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      ".dsh-svn-histdmsg{padding:2px 12px 6px;font-size:12px;color:#c9d1d9;white-space:pre;flex:0 1 auto;max-height:45%;min-height:0;overflow:auto;scrollbar-width:thin}",
