...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      ".dsh-svn-histdhead{display:flex;gap:8px;align-items:baseline;padding:6px 12px 2px;font-size:11px;background:rgba(148,163,184,.08);border-bottom:1px solid rgba(148,163,184,.12);flex-shrink:0}",
      ".dsh-svn-histdmsg{padding:2px 12px 6px;font-size:12px;color:#c9d1d9;white-space:pre-wrap;word-break:break-all;flex-shrink:0}",
      ".dsh-svn-histdfiles{flex:1;min-height:0;overflow:auto;padding:2px 0 6px}",
