...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      ".dsh-svn-histdhead{display:flex;gap:8px;align-items:baseline;padding:6px 12px 2px;font-size:11px;background:rgba(148,163,184,.08);border-bottom:1px solid rgba(148,163,184,.12);position:sticky;top:0;z-index:2}",
